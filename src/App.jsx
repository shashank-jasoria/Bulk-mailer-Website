        ...
        <section className="section" id="product">
          <div className="container">
            <div className="section-heading section-heading--center reveal">
              ...
              <p>
                The extension handles the fast moment-by-moment workflow. Your
                SaaS backend and web app handle contacts, templates, sending,
                account access, billing, and analytics.
              </p>
            </div>
        ...
        <section className="section final-cta">
          <div className="container final-cta__panel reveal">
            <div>
              ...
              <p>
                Install the extension, create your account, and build the rest
                of the workflow around the way you already research people and
                companies.
              </p>
            </div>
            <a
